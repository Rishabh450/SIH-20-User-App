...
public class Crime {
    ...
    String crime_id,criminal_id,crime_adder_authority_Id,district_of_crime,
            ...
            ,rating_of_crime, time_when_crime_added, main_crime_type;

    public Crime() {

    }

    public Crime(String crime_id, String criminal_id, String crime_adder_authority_Id, String district_of_crime, String state_of_crime,
                 String date_of_crime, String case_status, String crime_type, String address_of_crime, String time_when_crime_added,
                 String rating_of_crime, String main_crime_type) {
